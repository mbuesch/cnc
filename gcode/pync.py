...
#
# Copyright (c) 2010-2018 Michael Buesch <m@bues.ch>
#
...
class _Line_Metaclass(type):
	"""Metaclass for class Line.
	"""

	def __meta_merge(self, other):
		return self()._merge(other)

	__add__		= __meta_merge # a + b
	__sub__		= __meta_merge # a - b
	__mul__		= __meta_merge # a * b
	__lshift__	= __meta_merge # a << b
	__rshift__	= __meta_merge # a >> b
	__and__		= __meta_merge # a & b
	__xor__		= __meta_merge # a ^ b
	__or__		= __meta_merge # a | b

@six.add_metaclass(_Line_Metaclass)
class Line(object):
	...
	__sub__		= _merge # a - b
	__mul__		= _merge # a * b
	__lshift__	= _merge # a << b
	__rshift__	= _merge # a >> b
	__and__		= _merge # a & b
	__xor__		= _merge # a ^ b
	__or__		= _merge # a | b
...
lt = lambda a, b: not equal(a, b) and a < b
gt = lambda a, b: not equal(a, b) and a > b
